...
import com.dedalow.actions.GivenAcceder_a_la_HomePageAction;
...
public class Release5Background_Release5{
	...
	private static GivenAcceder_a_la_HomePageAction givenAcceder_a_la_HomePageAction;
    
    
    
    

    public Release5Background_Release5(Class reflectiveClass) throws Exception {
		...
		givenAcceder_a_la_HomePageAction = new GivenAcceder_a_la_HomePageAction(reflectiveClass); 
    ...
    public void doBackground_Release5() throws Exception {

            Report.reportLog(reflectiveClass, "BeforeEach Background_Release5 of execution", "INFO", 0, Status.PASS, false, "", "", null);
            
			
			givenAcceder_a_la_HomePageAction.doGivenAcceder_a_la_HomePageAction();
            Report.reportLog(reflectiveClass, "Action GivenAcceder_a_la_HomePageAction finished","INFO", 0, Status.PASS, false, "", "", null);
