...
import com.dedalow.actions.GivenBackendsAction;
...
public class SuiteBackendBeforeEach{
	...
	private static GivenBackendsAction givenBackendsAction;
    
    
    
    

    public SuiteBackendBeforeEach(Class reflectiveClass) throws Exception {
		...
		givenBackendsAction = new GivenBackendsAction(reflectiveClass); 
    ...
    public void doBeforeEach() throws Exception {
			...
			givenBackendsAction.doGivenBackendsAction();
            Report.reportLog(reflectiveClass, "Action GivenBackendsAction finished","INFO", 0, Status.PASS, false, "", "", null);
