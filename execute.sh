...
cd /app/projectFolderExe && zip -r ./supertestjunitExe.zip . -x "execute.sh"
...
echo "{ \"operation\": \"create\", \"data\": \"$( base64 supertestjunitExe.zip )\", \"metadata\": { \"blobName\": \"${BUILD_ID}.zip\" } }" > data.json
