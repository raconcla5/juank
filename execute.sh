...
cd /app/projectFolderExe && zip -r ./cucumberactExe.zip . -x "execute.sh"
...
echo "{ \"operation\": \"create\", \"data\": \"$( base64 cucumberactExe.zip )\", \"metadata\": { \"blobName\": \"${BUILD_ID}.zip\" } }" > data.json
